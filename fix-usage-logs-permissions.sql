-- Fix permissions for get_aggregated_usage_logs function
...
-- Create function with SECURITY DEFINER to access auth.users
...
COMMENT ON FUNCTION get_aggregated_usage_logs IS 'Aggregates usage logs by user with activity levels, search, and pagination - SECURITY DEFINER for auth.users access';
