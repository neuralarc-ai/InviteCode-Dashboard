-- Database Performance Indexes for Activity Functionality (CORRECTED VERSION)
...
-- Using a fixed date to avoid IMMUTABLE function error
...
-- Using IS NOT NULL instead of NOW() to avoid IMMUTABLE function error
